...
import com.huskytacodile.alternacraft.block.entity.DNAExtractorBlockEntity;
import com.huskytacodile.alternacraft.screen.slot.ModFuelSlot;
...
public class DNAExtractorMenu extends AbstractContainerMenu {
    ...
    public DNAExtractorMenu(int windowId, Inventory inv, FriendlyByteBuf extraData) {
        this(windowId, inv, inv.player.level.getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(4));
    }

    public DNAExtractorMenu(int windowId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.DNA_EXTRACTOR_MENU.get(), windowId);
