...
public class AlternaBiomeProvider extends BiomeProvider {

    public AlternaBiomeProvider(ResourceLocation name, int overworldWeight)
    {
    ...
    public void addOverworldBiomes(Registry<Biome> registry, Consumer<Pair<TBClimate.ParameterPoint, ResourceKey<Biome>>> mapper)
    {
        this.addModifiedVanillaOverworldBiomes(mapper, builder -> {
            ...
            builder.replaceBiome(Biomes.DESERT, AlternaBiomes.ALTERNA);
            ...
            frozenPeaksPoints.forEach(point -> builder.replaceBiome(point, AlternaBiomes.ELEMENT));
        });
    }
    ...
    {
        return Optional.of(AlternaSurfaceRuleData.makeRules());
    }
