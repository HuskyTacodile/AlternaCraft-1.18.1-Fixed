...
public class ModPlacedFeatures {
    public static final PlacedFeature TITANIUM_ORE_PLACED = PlacementUtils.register("titanium_ore_placed",
            ModConfiguredFeature.TITANIUM_ORE.placed(ModOrePlacement.commonOrePlacement(8, // VeinsPerChunk
                    HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(-80), VerticalAnchor.aboveBottom(80)))));

    public static final PlacedFeature PAINITE_ORE_PLACED = PlacementUtils.register("painite_ore_placed",
            ModConfiguredFeature.PAINITE_ORE.placed(ModOrePlacement.commonOrePlacement(4, // VeinsPerChunk
                    HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(-80), VerticalAnchor.aboveBottom(80)))));

    public static final PlacedFeature FOSSIL_ORE_PLACED = PlacementUtils.register("fossil_ore_placed",
