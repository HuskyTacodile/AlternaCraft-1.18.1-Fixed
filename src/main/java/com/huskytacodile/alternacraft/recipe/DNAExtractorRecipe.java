...
public class DNAExtractorRecipe implements Recipe<SimpleContainer> {
    ...
    public DNAExtractorRecipe(ResourceLocation id, ItemStack output,
    ...
    public static class Serializer implements RecipeSerializer<DNAExtractorRecipe> {
        ...
        public static final ResourceLocation ID = new ResourceLocation(Alternacraft.MOD_ID,"dna_extracting");
